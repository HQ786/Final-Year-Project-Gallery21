...
const Home = () => {
  return (
    <>
      <Head>
        <title>Gallery21 Art Gallery</title>
        <meta charSet="UTF-8" />
      ...
      <main>
        <header>
          <img className="hero-image-mobile" src="/assets/mobile/image-hero@2x.jpg" alt="Art Gallery Picture" />
          <div className="container">
            <div className="hero-section">
              <h1 className="heading-xl h1-heading">Gallery21 An Art Gallery</h1>
              <div className="hero-text">
                <p className="body-m hero-paragraph pb-64">
                  The arts in the collection of the <span>Modern Art Gallery</span> all started from a spark of inspiration.
                  Will these pieces inspire you? <span>Visit us and find out.</span>
                </p>
                <div className="btn">
        ...
        <article className="container">
          <div className="grid">
            <div className="top-feature-left">
              ...
              <p className="body-m">Wander through our distinct collections and find new about our artists. Dive into the details of their creative process.</p>
            </div>
            ...
            <div className="right-feature-2">
              ...
              <p className="body-m-white">We’re excited to welcome you to our gallery and see how our collections influence you.</p>
            </div>
          </div>
        </article>
      </main>
      <footer>
        <div className="container flex">
          <img className="logo" src="/assets/logo-light.svg" alt="Gallery21 Logo" />
          <p className="body-xs">
            Gallery21 is free to all visitors and open seven days a week from 8am to 6pm. Find us at 21 Orchard Rd, Sector C DHA Phase II,
